                            ...
                            <div className="p-6 md:p-8">
                                ...
                                <div className="space-y-4 mb-6">
                                    ...
                                    <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-slate-800/50 rounded-xl">
                                        <div className="flex-1">
                                            <div className="flex items-center gap-3 mb-2">
                                                <div className={`w-2 h-2 rounded-full ${preferences.analytics ? 'bg-blue-500' : 'bg-gray-300 dark:bg-gray-600'}`}></div>
                                    ...
                                    <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-slate-800/50 rounded-xl">
                                        <div className="flex-1">
                                            <div className="flex items-center gap-3 mb-2">
                                                <div className={`w-2 h-2 rounded-full ${preferences.marketing ? 'bg-purple-500' : 'bg-gray-300 dark:bg-gray-600'}`}></div>
                                    ...
                                    <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-slate-800/50 rounded-xl">
                                        <div className="flex-1">
                                            <div className="flex items-center gap-3 mb-2">
                                                <div className={`w-2 h-2 rounded-full ${preferences.functional ? 'bg-emerald-500' : 'bg-gray-300 dark:bg-gray-600'}`}></div>
