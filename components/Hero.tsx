...
export default function Hero() {
    ...
    return (
        <section className="relative min-h-screen overflow-hidden bg-background dark:bg-background">
            ...
            <div className="relative z-10 min-h-screen flex items-center">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        ...
                        {/* Left side - Content */}
                        <div className={`space-y-8 transition-all duration-1200 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}>
                            {/* Badge */}
                            ...
                            {/* Description */}
                            <p className={`text-xl md:text-2xl text-secondary leading-relaxed max-w-2xl transition-all duration-1200 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                                Crafting extraordinary digital experiences that push boundaries and redefine what's possible in modern design.
                            </p>

                            {/* CTA Buttons */}
                            <div className={`flex flex-col sm:flex-row gap-4 pt-4 transition-all duration-1200 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                                <Link
                                    href="/portfolio"
                            ...
                            {/* Stats */}
                            <div className={`flex items-center space-x-8 pt-8 transition-all duration-1200 delay-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                        ...
                        {/* Right side - Visual */}
                        <div className={`relative transition-all duration-1200 delay-200 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`}>
                                    ...
                                    <div className="relative bg-background/95 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-border">
                                        ...
                                        <div className="space-y-6">
                                            ...
                                            <div className="flex space-x-2">
                                                <div className="w-8 h-8 rounded-lg shadow-lg" style={{ backgroundColor: '#BFAD99' }} />
                                                <div className="w-8 h-8 rounded-lg shadow-lg" style={{ backgroundColor: '#F0E5D4' }} />
                                                <div className="w-8 h-8 rounded-lg shadow-lg" style={{ backgroundColor: '#D5CBC1' }} />
                                                <div className="w-8 h-8 rounded-lg shadow-lg" style={{ backgroundColor: '#FFF9F1' }} />
                                            </div>
                                        </div>
                                    </div>
            ...
            {/* Scroll indicator */}
            <div className={`absolute bottom-8 left-1/2 transform -translate-x-1/2 transition-all duration-1200 delay-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
