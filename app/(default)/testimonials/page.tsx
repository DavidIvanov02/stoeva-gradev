      ...
      <section className='py-20 bg-background'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          <p className='text-xl md:text-2xl text-secondary max-w-3xl mx-auto'>
            Discover what our clients say about their experience working with us and the results
        ...
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          <div className='bg-background p-8 md:p-12 rounded-3xl shadow-xl'>
            ...
            <blockquote className='text-2xl md:text-3xl font-serif text-foreground mb-8 leading-relaxed'>
              &ldquo;Stoeva Gradev doesn&apos;t just create designs; they create experiences. Their
              work has fundamentally transformed how our customers perceive and interact with our
              brand.&rdquo;
            </blockquote>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            <div className='text-center'>
              ...
              <p className='text-secondary'>
                We deliver high-quality results on time, every time, without compromising on
                excellence.
              </p>
            </div>
            <div className='text-center'>
              ...
              <p className='text-secondary'>
                Every project receives personalized attention and care, ensuring unique solutions
                for each client.
              </p>
            </div>
            <div className='text-center'>
              ...
              <p className='text-secondary'>
                Our track record speaks for itself with measurable improvements in brand perception
                and engagement.
              </p>
            </div>
          </div>
      ...
      <section className='py-20 bg-muted'>
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          <p className='text-xl text-secondary mb-8'>
            Let&apos;s create something amazing together and add your testimonial to our growing
            collection.
          </p>
