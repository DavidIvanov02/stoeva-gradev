                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        <div>
                            ...
                            <p className="text-lg text-secondary mb-8">
                                We&apos;re excited to learn about your project and discuss how we can help you achieve your design goals.
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="space-y-6">
                        <div className="bg-background p-6 rounded-lg">
                            <h3 className="text-xl font-serif mb-3 text-foreground">How long does a typical project take?</h3>
                            <p className="text-secondary">
                                Project timelines vary depending on scope and complexity. Brand identity projects typically take 2-4 weeks,
                                web design projects 4-8 weeks, and print design projects 1-2 weeks.
                            </p>
                        </div>

                        <div className="bg-background p-6 rounded-lg">
                            <h3 className="text-xl font-serif mb-3 text-foreground">What&apos;s included in your design packages?</h3>
                            <p className="text-secondary">
                                Each package includes initial consultation, concept development, design iterations, final files in multiple formats,
                                and basic brand guidelines. Specific deliverables vary by service type.
                            </p>
                        </div>

                        <div className="bg-background p-6 rounded-lg">
                            <h3 className="text-xl font-serif mb-3 text-foreground">Do you work with international clients?</h3>
                            <p className="text-secondary">
                                Yes! We work with clients worldwide. We&apos;re experienced in remote collaboration and use modern tools
                                to ensure smooth communication regardless of location or time zone.
                            </p>
                        </div>

                        <div className="bg-background p-6 rounded-lg">
                            <h3 className="text-xl font-serif mb-3 text-foreground">What&apos;s your revision policy?</h3>
                            <p className="text-secondary">
                                We include up to 3 rounds of revisions in our standard packages. Additional revisions can be accommodated
                                for an additional fee. We work closely with you to ensure the final result exceeds your expectations.
                            </p>
                        </div>
                    </div>
                </div>
