      ...
      <section className='py-20 bg-background'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20'>
            <div>
              <h2 className='text-4xl md:text-5xl font-serif mb-6 text-foreground'>Our Story</h2>
              <p className='text-lg text-secondary mb-6'>
                We are a creative design studio dedicated to crafting exceptional visual
                experiences. Our team combines artistic vision with strategic thinking to deliver
                designs that not only look beautiful but also achieve your business objectives.
              </p>
              ...
              <p className='text-lg text-secondary'>
                Every project we undertake is approached with fresh eyes and innovative thinking. We
                believe that great design is not just about aesthetics—it&apos;s about solving
                problems, telling stories, and creating meaningful connections between brands and
                their audiences.
              </p>
            </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
              <div className='text-center'>
                ...
                <p className='text-secondary'>
                  We constantly push boundaries and explore new creative possibilities to deliver
              ...
              <div className='text-center'>
                ...
                <p className='text-secondary'>
                  Every project is infused with our genuine love for design and commitment to
                  excellence.
                </p>
              </div>
              ...
              <div className='text-center'>
                ...
                <p className='text-secondary'>
                  We work closely with our clients as partners to ensure their vision becomes
                  reality.
                </p>
              </div>
            </div>
