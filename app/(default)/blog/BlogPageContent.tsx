        ...
        <section className='py-20 bg-background'>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-secondary'>Our most popular and insightful posts</p>
            </div>
              ...
              {featuredPosts.map(post => (
                ...
                >
                  ...
                  <div className='p-8'>
                    ...
                    <p className='text-secondary leading-relaxed mb-6'>{post.excerpt}</p>
      ...
      <section className='py-20 bg-muted'>
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          <div className='bg-background p-8 md:p-12 rounded-3xl shadow-xl'>
            <h2 className='text-4xl md:text-5xl font-serif mb-6 text-foreground'>Stay Updated</h2>
