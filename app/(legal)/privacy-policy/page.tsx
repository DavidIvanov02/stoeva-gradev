                    ...
                    <div className="prose prose-lg max-w-none">
                        ...
                        <div className="mb-12">
                            ...
                            <div className="bg-muted p-8 rounded-2xl">
                                <h3 className="text-xl font-serif mb-4 text-primary">Automatically Collected Information</h3>
                                <p className="text-secondary leading-relaxed mb-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="bg-primary/5 p-6 rounded-xl border border-primary/10">
                                    ...
                                    <p className="text-secondary text-sm leading-relaxed">
                                        To provide our design services, communicate about projects, and deliver the creative solutions you&apos;ve requested.
                                    </p>
                                </div>
                                <div className="bg-accent/5 p-6 rounded-xl border border-accent/10">
                                    ...
                                    <p className="text-secondary text-sm leading-relaxed">
                                        To respond to inquiries, send project updates, and provide customer support throughout our collaboration.
                                    </p>
                                </div>
                                <div className="bg-primary/5 p-6 rounded-xl border border-primary/10">
                                    <h3 className="text-lg font-serif mb-3 text-primary">Improvement</h3>
                                    <p className="text-secondary text-sm leading-relaxed">
                                        To analyze website usage, improve our services, and enhance the overall user experience.
                                    </p>
                                </div>
                                <div className="bg-accent/5 p-6 rounded-xl border border-accent/10">
                        ...
                        <div className="mb-12">
                            ...
                            <div className="bg-muted/30 p-8 rounded-2xl border border-primary/10">
                                ...
                                <ul className="list-disc list-inside text-secondary space-y-3 ml-4">
                                    <li><strong className="text-foreground">Service Providers:</strong> Trusted third-party services that help us operate our business (hosting, analytics, payment processing)</li>
                                    ...
                                    <li><strong className="text-foreground">With Consent:</strong> When you explicitly agree to share information with specific third parties</li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div className="bg-muted p-8 rounded-2xl">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div className="text-center p-4">
                                        ...
                                        <p className="text-sm text-secondary">SSL/TLS encryption for data transmission</p>
                                    </div>
                                    <div className="text-center p-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-secondary">Update or correct inaccurate information</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start space-x-3">
                                        <div className="w-6 h-6 bg-primary rounded-full flex-shrink-0 mt-1 flex items-center justify-center">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-secondary">Request removal of your personal data</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start space-x-3">
                                        <div className="w-6 h-6 bg-primary rounded-full flex-shrink-0 mt-1 flex items-center justify-center">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-secondary">Receive your data in a portable format</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section className="py-16 bg-primary">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                        We&apos;re here to help. Reach out to us with any questions or concerns about how we handle your data.
                    </p>
