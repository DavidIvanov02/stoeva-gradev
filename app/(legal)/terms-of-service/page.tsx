    ...
    <div className='min-h-screen bg-background'>
      <section className='py-20 bg-muted/20'>
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          <h1 className='text-5xl md:text-6xl font-serif mb-6 text-primary'>Terms of Service</h1>
          <p className='text-xl text-secondary mb-8 max-w-2xl mx-auto'>
            These terms govern your use of our services and establish the foundation for our
        ...
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='prose prose-lg max-w-none'>
            <div className='mb-12'>
              ...
              <div className='bg-gradient-to-r from-primary/5 to-accent/5 p-8 rounded-2xl border border-primary/10'>
                <p className='text-secondary leading-relaxed mb-4'>
                  By accessing and using Stoeva Gradev&apos;s services, you accept and agree to be
              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
                <div className='bg-primary/5 p-6 rounded-xl border border-primary/10'>
                  ...
                  <p className='text-secondary text-sm leading-relaxed'>
                    Complete brand identity design including logos, color palettes, and brand
                    guidelines.
                  </p>
                </div>
            ...
            <div className='mb-12'>
              ...
              <div className='bg-muted p-8 rounded-2xl'>
                <p className='text-secondary leading-relaxed mb-6'>
                  To ensure successful project completion, clients are expected to fulfill the
                    ...
                    <div className='flex items-start space-x-3'>
                      ...
                      <div>
                        ...
                        <p className='text-sm text-secondary'>
                          Respond to requests and provide feedback within agreed timeframes
                        </p>
                      </div>
                    </div>
                    <div className='flex items-start space-x-3'>
                      ...
                      <div>
                        ...
                        <p className='text-sm text-secondary'>
                          Supply all necessary content, images, and materials as requested
                        </p>
                      </div>
                    </div>
                    <div className='flex items-start space-x-3'>
                      ...
                      <div>
                        ...
                        <p className='text-sm text-secondary'>
                          Provide detailed project requirements and specifications
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                  <div>
                    ...
                    <ul className='space-y-3 text-secondary'>
                      <li className='flex items-start space-x-3'>
                        ...
                        <span>
                          <strong className='text-foreground'>50% Deposit:</strong> Required before
                      ...
                      <li className='flex items-start space-x-3'>
                        <span className='w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0'></span>
                        <span>
                          <strong className='text-foreground'>50% Final Payment:</strong> Due upon
                          project completion
                        </span>
                      </li>
                      <li className='flex items-start space-x-3'>
                        ...
                        <span>
                          <strong className='text-foreground'>Large Projects:</strong> May be
                          divided into milestone payments
                        </span>
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <div className='space-y-3'>
                      ...
                      <p className='text-sm text-secondary'>
                        <strong className='text-foreground'>Late Payment:</strong> 2% monthly fee
                        applies to overdue invoices
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className='mb-12'>
              ...
              <div className='bg-muted p-8 rounded-2xl'>
                ...
                <div className='mt-6 p-6 bg-background rounded-xl border border-border'>
                  ...
                  <p className='text-secondary text-sm leading-relaxed'>
                    Ownership transfer occurs only upon full payment. Until then, all work remains
                    the property of Stoeva Gradev. Third-party assets (stock photos, fonts, etc.)
                    may require separate licensing by the client.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className='bg-gradient-to-r from-primary/5 to-accent/5 p-8 rounded-2xl border border-primary/10'>
                <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
                  <div className='text-center'>
                    ...
                    <p className='text-sm text-secondary'>
                      Three rounds of revisions included in base price
                    </p>
                  </div>
                  <div className='text-center'>
                    ...
                    <p className='text-sm text-secondary'>
                      Charged at hourly rate for revisions beyond included amount
                    </p>
                  </div>
                  <div className='text-center'>
                    <div className='w-16 h-16 bg-primary rounded-lg mx-auto mb-4 flex items-center justify-center'>
            ...
            <div className='mb-12'>
              ...
              <div className='bg-muted p-8 rounded-2xl'>
                <p className='text-secondary leading-relaxed mb-6'>
                  While we strive for excellence in all our work, the following limitations apply to
                  our liability:
                </p>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                  <div className='bg-background p-6 rounded-xl border border-border'>
                    ...
                    <p className='text-secondary text-sm leading-relaxed'>
                      Our total liability for any claim shall not exceed the total amount paid by
                      the client for the specific project in question.
                    </p>
                  </div>
                  <div className='bg-background p-6 rounded-xl border border-border'>
                ...
                <div className='mt-6 p-6 bg-primary/5 rounded-xl border border-primary/10'>
                  ...
                  <p className='text-secondary text-sm leading-relaxed'>
                    Clients are responsible for backing up their data and ensuring compliance with
                    all applicable laws and regulations regarding the use of our deliverables.
                  </p>
                </div>
              </div>
            </div>
